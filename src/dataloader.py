...
domain2entity={
    ...
    'ontonotes-c': ['CARDINAL', 'DATE', 'EVENT', 'FAC', 'GPE', 'LAW', 'LOC', 'LANGUAGE', 'MONEY', 'NORP', 'ORG', 'ORDINAL', 'PERSON', 'PRODUCT', 'PERCENT', 'QUANTITY', 'TIME', 'WORK_OF_ART'],


    'FewCOMM': ['材质', '适用季节', '其他属性', '版型', '功能功效', '适用对象', '接口', '送礼对象', '运输服务', '颜色', '组合形式', '厚薄', '锅底类型', '袖型', '袖长', '配件类型', '筒高', '适用人数', '脂肪含量', '造型', '厚度', '产地', '商品特色', '赠品', '面料材质', '成分', '型号', '分类', '适用运营商', '供电方式', '国产/进口', '大小', '控制方式', '适用人群', '糖含量', '是否净洗', '酸碱度', '果肉颜色', '礼盒类型', '定制服务', '香型', '是否去骨', '鞋垫材质', '长度', '适用衣物', '品质等级', '是否有机', '形状形态', '适用空间', '长短', '外观', '是否去皮', '存储容量', '领型', '填充材质']
